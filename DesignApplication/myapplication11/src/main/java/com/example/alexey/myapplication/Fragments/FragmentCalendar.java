package com.example.alexey.myapplication.Fragments;
...
import com.example.alexey.myapplication.R;
import com.example.alexey.myapplication.TrainingClass;
import com.example.alexey.myapplication.ZamerAdapter;
import com.example.alexey.myapplication.ZamerAddActivity;
...
public class FragmentCalendar extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_fragment_calendar, container, false);

         final RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view);


        final View mFabButton =  view.findViewById(R.id.fab_button);

        mFabButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent i  = new Intent (getActivity(),
                        ZamerAddActivity.class);

                ActivityOptions transitionActivityOptions = ActivityOptions.makeSceneTransitionAnimation(
                        getActivity(), Pair.create(mFabButton, "fab"));
